    ...
    <div class="row">
                    ...
                    <form action="{{ route('admin.cars.update', $car->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="p3k" id="p3k" class="form-control">
                                ...
                                <option {{ $car->p3k === 0 ? 'selected' : null }} value="0">Tidak Tersedia
                                </option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="audio" id="audio" class="form-control">
                                ...
                                <option {{ $car->audio === 0 ? 'selected' : null }} value="0">Tidak Tersedia
                                </option>
                            </select>
                        </div>
                        <div class="form-group">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.cars.updateImage', $car->id) }}" method="post"
